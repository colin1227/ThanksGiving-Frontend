...
export default class Food extends Component {
    ...
    createFood = async(e) => {
        e.preventDefault()
        try{
            await fetch('https://nameless-headland-14799.herokuapp.com/table/insert',{
                method: "POST",
                credentials: "include",
    ...
    deleteFood = async(name, e) => {
        e.preventDefault()
        try{
            const foodJson = await fetch('https://nameless-headland-14799.herokuapp.com/table/remove',{
                method: "DELETE",
                credentials: "include",
                headers: {'Content-Type': "application/json"},
                body: JSON.stringify({
